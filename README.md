...
Atualmente sou estudante de **Análise e Desenvolvimento de Sistemas (ADS)** e estou constantemente estudando e desenvolvendo projetos voltados para **Ciência de Dados e Machine Learning**.

Tenho foco em dados, análise e criação de modelos, buscando evoluir continuamente minhas habilidades em programação e Data Science.
...
<p align="left"> 
  ...
  <br>
  Me chamo <strong>Gabryel Arrache</strong> e minha área de interesse é <strong>Ciência de Dados e Machine Learning</strong>. <br>
  Atualmente curso ADS e sigo aprimorando meus conhecimentos através de projetos práticos, estudos e desenvolvimento de modelos de dados.
</p>

<p align="left">

🦄 Objetivo: **Aprendizagem contínua e crescimento na área de Dados, Data Science e Machine Learning.**
